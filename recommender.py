...
import numpy as np
 ...
 # COO 형식의 행렬을 만들기 위해 사용
from scipy.sparse import coo_matrix

 # 알고리즘(머신러닝) 사용을 위해 import
...
import json
 ...
 # Python에서 실행되는 과학 계산 라이브러리들이 사용하는 다중 스레드(multithreading)를 제어하기 위한 함수 호출
...
# coo_matrix : COO 형식의 행렬을 만들기 위해 사용
# csr_matrix : CSR 형식의 행렬을 만들기 위해 사용
...
if __name__ == "__main__":
  ...
  model_train() # 데이터를 학습하여 모델을 생성하는 함수 호출. 처음 한 번 실행 후 주석 처리. 이후 데이터가 추가됐을 때 주기적으로 실행
